...
const services = [
  { title: "Virtual\nwallet", icon: Wallet, tone: "bg-violet-100 text-violet-400" },
  { title: "Group\ndistrubution", icon: BadgeCheck, tone: "bg-rose-100 text-rose-400" },
  { title: "Ghost\nagent", icon: Sparkles, tone: "bg-sky-100 text-sky-400" },
  { title: "Ussage\nTracking", icon: WandSparkles, tone: "bg-amber-100 text-amber-400" },
  { title: "Subscription\nanalysis", icon: BarChart3, tone: "bg-green-100 text-green-400" },
];
const workCards = [
  {
    title: "Wallet",
...
function BrandMark() {
  return (
    <div className="flex items-center gap-2">
      <div className="grid h-8 w-8 place-content-center rounded-full bg-zinc-900">
        <div className="h-3.5 w-3.5 rotate-45 rounded-[3px] border-[3px] border-white" />
      </div>
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#e5f5ff] via-[#f6f6f6] to-[#f7f5f1] text-zinc-900">
      <div className="mx-auto w-full max-w-[1360px] px-4 sm:px-6">
        <div ref={heroSectionRef} id="home">
          <header className="fixed inset-x-0 top-0 z-50">
            <div className="mx-auto max-w-[1180px] px-4 pt-4 sm:px-6">
              <div className="flex items-center justify-between gap-3 rounded-[100px] border border-white/20 bg-white/10 px-3 py-2 shadow-[0_8px_30px_rgba(15,23,42,0.06)] backdrop-blur-md">
              <BrandMark />

              <nav className="hidden items-center gap-1 rounded-full bg-[#e9e7df] p-1 lg:flex">
                {navItems.map((item, idx) => (
                  <Link
                    ...
                    className={`rounded-full px-4 py-1 text-[22px] transition xl:text-[14px] ${
                      idx === 0 ? "bg-white text-zinc-900 shadow-sm" : "text-zinc-600 hover:bg-white/70"
                    }`}
                  >
                    {item.label}
                  </Link>
              ...
              <div className="flex items-center">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-zinc-900 px-4 py-1.5 text-[14px] font-medium text-white transition hover:bg-zinc-800"
                >
                  Login
                  <span className="grid h-7 w-7 place-content-center rounded-full bg-white text-zinc-900">
          ...
          <h1 className="text-[62px] font-semibold leading-[1.06] tracking-tight text-zinc-900 sm:text-[84px] lg:text-[124px]">
            ...
            <div className={`${playHeroAnim ? "paragraph-load-up" : "paragraph-hidden"} mx-auto max-w-4xl`}>
              <p className="mx-auto mt-6 text-[16px] leading-relaxed text-zinc-500 sm:text-[38px] lg:text-[40px] xl:text-[16px]">
              ...
              <div className="flex items-center gap-4">
                <div className="flex -space-x-3">
                  {[0, 1, 2, 3].map((person) => (
                    <div
                      key={person}
                      className="h-9 w-9 rounded-full border-2 border-[#ececec] bg-gradient-to-br from-zinc-200 to-zinc-400"
                    />
                  ))}
                </div>
                <div>
                  <p className="text-[18px] leading-none text-amber-500">?????</p>
                  <p className="mt-1 text-[16px] text-zinc-500">Trusted by 200+ clients</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="px-6 pb-20 pt-16 sm:px-10 sm:pt-20">
          <div className="mx-auto max-w-[1220px]">
            <div className="mb-10 flex items-center gap-4">
              ...
              <p className="whitespace-nowrap text-center text-[15px] text-zinc-600">
        ...
        <section id="about-us" ref={aboutSectionRef} className="px-6 pb-24 pt-10 sm:px-10 sm:pt-14">
          <div className="mx-auto max-w-[1280px]">
            <h2
              className="about-heading-reveal mx-auto max-w-[980px] text-center text-[26px] font-semibold leading-[1.2] tracking-tight text-zinc-900 sm:text-[40px] lg:text-[46px]"
            ...
            <div className="mt-5 flex flex-wrap items-center justify-center gap-2 sm:gap-2.5">
              <div className="inline-flex items-center gap-2 rounded-full bg-violet-100 px-3 py-1.5 text-violet-500 sm:px-5">
                <Sparkles className="h-4 w-4" />
                <span className="font-serif text-[18px] italic sm:text-[26px]">Escrow wallet</span>
              </div>
              <div className="inline-flex items-center gap-2 rounded-full bg-sky-100 px-3 py-1.5 text-sky-500 sm:px-5">
                <Lightbulb className="h-4 w-4" />
                <span className="font-serif text-[18px] italic sm:text-[26px]">usage</span>
              </div>
              <div className="inline-flex items-center gap-2 rounded-full bg-amber-100 px-3 py-1.5 text-amber-500 sm:px-5">
            ...
            <div ref={aboutStatsRef} className="mt-28 grid gap-16 sm:grid-cols-3 sm:gap-0">
              {aboutStats.map((stat, idx) => (
                <div
                  key={stat.label}
                  className={`text-center ${idx > 0 ? "sm:border-l sm:border-zinc-300/70 sm:pl-6" : ""} ${idx < 2 ? "sm:pr-6" : ""}`}
                >
                  <p className="text-[120px] font-semibold leading-[1.12] tracking-tight text-zinc-900 sm:text-[150px]">
                    +{aboutCounts[idx]}
                  </p>
                  <p className="mt-8 text-[18px] leading-loose text-zinc-500 sm:text-[20px]">{stat.label}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="services" className="px-6 pb-24 pt-4 sm:px-10 sm:pt-8">
          <div className="mx-auto max-w-[1280px]">
            <h2 className="text-center text-[34px] font-semibold leading-[1.16] tracking-tight text-zinc-900 sm:text-[46px] lg:text-[54px]">
              <span className="block">Where Subscriptions</span>
              <span className="block font-serif italic font-medium text-zinc-500">become intentional</span>
            </h2>
              ...
              {services.map((service) => {
                ...
                return (
                  <article
                    ...
                    className={`service-parallax-card rounded-2xl p-6 shadow-[0_14px_34px_rgba(15,23,42,0.14)] ${service.tone}`}
                  >
                    <Icon className="h-7 w-7" />
                    <h3 className="mt-7 whitespace-pre-line text-[30px] font-medium leading-[1.05] text-zinc-800 sm:text-[24px]">
                      {service.title}
                    </h3>
                  </article>
                );
            ...
            <div className="mt-8 rounded-4xl bg-zinc-900 px-8 py-9 text-white sm:px-10">
              <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <button
                    type="button"
                    className="inline-flex items-center gap-4 rounded-full border border-zinc-500 px-7 py-2.5 text-[16px] font-medium text-white"
                  >
                    View Portfolio
        ...
        <section
          id="work"
          className="bg-gradient-to-b from-[#f7f5f1] via-[#fbfbfb] to-white px-6 pb-18 pt-8 sm:px-10 sm:pt-10"
        >
          <div className="mx-auto max-w-[1280px]">
            <h2 className="text-center text-[30px] font-semibold leading-[1.2] tracking-tight text-zinc-900 sm:text-[40px] lg:text-[46px]">
              How we transformed a small business&apos;s
              <span className="font-serif italic font-medium text-zinc-500"> online presence</span>
            </h2>
            ...
            <div className="mt-12 grid gap-8 lg:grid-cols-2">
              {workCards.map((card) => (
                <article
                  ...
                  className="relative"
                >
                  <div className="overflow-hidden rounded-3xl border border-white/40 bg-white/20 shadow-[0_18px_50px_rgba(15,23,42,0.18)] backdrop-blur-sm">
                  ...
                  <h3 className="relative z-30 mt-4 inline-block rounded-xl bg-white/90 px-2 py-1 text-[24px] font-medium leading-none text-zinc-800 sm:text-[22px]">
                    {card.title}
                  </h3>
                </article>
              ))}
        ...
        <section id="awards" ref={reviewsSectionRef} className="bg-white px-6 pb-24 pt-4 sm:px-10 sm:pt-8">
          <div className="mx-auto max-w-[1280px]">
            <h2 className="text-center text-[38px] font-semibold leading-[1.14] tracking-tight text-zinc-900 sm:text-[52px] lg:text-[64px]">
              What our satisfied customers
              <span className="block">
                are <span className="font-serif italic font-medium text-zinc-500">saying about us</span>
              </span>
            </h2>
            ...
            <div className="mt-12 grid gap-6 lg:grid-cols-[2.2fr_1fr]">
              ...
              <article className="rounded-3xl bg-[#ece28c] p-8" style={getReviewsParallaxStyle("right", 0.8)}>
                <p className="text-[13px] uppercase tracking-wide text-zinc-600">Facts &amp; Numbers</p>
            ...
            <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_2fr]">
              ...
              <article className="rounded-3xl bg-[#f1f1f3] p-8" style={getReviewsParallaxStyle("right", 1.35)}>
                <p className="text-sm uppercase tracking-wider text-zinc-500">Customer Stories</p>
                <p className="mt-8 max-w-4xl text-[24px] leading-[1.28] text-zinc-900 sm:text-[20px]">
                  &ldquo;PayXen brought our ideas to life with exceptional creativity and precision, exceeding expectations.&rdquo;
                </p>
                <p className="mt-52 text-[17px] text-zinc-900 sm:mt-36">Sarah Mitchell</p>
                <p className="text-[15px] text-zinc-500">Marketing Head at TalentConnect</p>
              </article>
            </div>
          </div>
        </section>

        <section className="bg-white px-6 pb-24 pt-2 sm:px-10">
          <div className="mx-auto max-w-[1080px]">
            <h2 className="text-center text-[42px] font-semibold leading-[1.14] tracking-tight text-zinc-900 sm:text-[58px] lg:text-[68px]">
              Got questions?
              <span className="block">
                We&apos;ve got <span className="font-serif italic font-medium text-zinc-500">answers</span>
              </span>
            </h2>
            ...
            <div className="mt-10 space-y-4">
              {faqItems.map((item) => (
                <button
                  key={item}
                  type="button"
                  className="flex w-full items-center justify-between rounded-3xl border border-zinc-200 bg-[#f6f6f6] px-6 py-5 text-left text-[20px] font-medium text-zinc-900 transition hover:bg-white sm:text-[17px]"
                >
                  <span>{item}</span>
        ...
        <section className="rounded-b-[2rem] bg-white px-6 pb-20 pt-2 sm:px-10">
          <div className="mx-auto max-w-[1280px] rounded-[2rem] border border-zinc-200 bg-gradient-to-r from-[#dff2ff] via-[#f6f6f6] to-[#f8efd3] p-10 text-center sm:p-14">
            <h3 className="text-[52px] font-semibold leading-[1.05] text-zinc-900 sm:text-[44px]">
              Innovative Solutions for{" "}
              <span className="font-serif italic font-medium text-zinc-500">bold brands</span>
            </h3>
            <p className="mx-auto mt-6 max-w-[760px] text-[20px] text-zinc-500 sm:text-[16px]">
            ...
            <button
              type="button"
              onClick={() => router.push("/signup")}
              className="mt-8 inline-flex items-center gap-4 rounded-full bg-zinc-900 px-7 py-3 text-[16px] font-medium text-white"
            >
        ...
        <footer className="bg-[#f7f5f1] px-6 pb-10 pt-10 sm:px-10">
          <div className="mx-auto grid max-w-[1280px] gap-10 border-t border-zinc-200 pt-12 lg:grid-cols-[2fr_1fr_1fr_1fr]">
            <div>
              <BrandMark />
              <p className="mt-5 max-w-[480px] text-[20px] leading-relaxed text-zinc-500 sm:text-[16px]">
              ...
              <div className="mt-6 flex items-center gap-4 text-zinc-500">
                ...
                <div className="h-6 w-6 rounded-full border-2 border-zinc-400" />
                <div className="h-6 w-6 rounded-full border-2 border-zinc-400" />
              </div>
            </div>

            <div>
              <h4 className="text-[20px] font-medium text-zinc-900 sm:text-[15px]">Sitemap</h4>
              <ul className="mt-5 space-y-3 text-[20px] text-zinc-500 sm:text-[14px]">
                <li>About us</li>
                <li>Work</li>
                <li>Services</li>
                <li>Pricing</li>
            ...
            <div>
              <h4 className="text-[20px] font-medium text-zinc-900 sm:text-[15px]">Other Pages</h4>
              <ul className="mt-5 space-y-3 text-[20px] text-zinc-500 sm:text-[14px]">
                <li>Contact Us</li>
                <li>Error 404</li>
              </ul>
            ...
            <div>
              <h4 className="text-[20px] font-medium text-zinc-900 sm:text-[15px]">Contact Details</h4>
              <ul className="mt-5 space-y-3 text-[20px] text-zinc-500 sm:text-[14px]">
          ...
          <div className="mx-auto mt-10 flex max-w-[1280px] flex-col items-start justify-between gap-4 border-t border-zinc-200 pt-6 text-[18px] text-zinc-500 sm:flex-row sm:text-[14px]">
